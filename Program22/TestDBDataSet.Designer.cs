...
namespace Program22 {
    ...
    public partial class TestDBDataSet : global::System.Data.DataSet {
        ...
        public partial class StudentDataTable : global::System.Data.TypedTableBase<StudentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public StudentRow AddStudentRow(string first_name, string last_name, string phone, string email) {
...
namespace Program22.TestDBDataSetTableAdapters {
    ...
    public partial class StudentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Student] ([first_name], [last_name], [phone], [email]) VALUES " +
                "(@first_name, @last_name, @phone, @email);\r\nSELECT student_id, first_name, last_" +
                "name, phone, email FROM Student WHERE (student_id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Student] SET [first_name] = @first_name, [last_name] = @last_name, [phone] = @phone, [email] = @email WHERE (([student_id] = @Original_student_id) AND ([first_name] = @Original_first_name) AND ([last_name] = @Original_last_name) AND ([phone] = @Original_phone) AND ([email] = @Original_email));
SELECT student_id, first_name, last_name, phone, email FROM Student WHERE (student_id = @student_id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Program22.Properties.Settings.Default.TestDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT student_id, first_name, last_name, phone, email FROM dbo.Student";
        ...
        public virtual int Delete(int Original_student_id, string Original_first_name, string Original_last_name, string Original_phone, string Original_email) {
        ...
        public virtual int Update(string first_name, string last_name, string phone, string email, int Original_student_id, string Original_first_name, string Original_last_name, string Original_phone, string Original_email, int student_id) {
            if ((first_name == null)) {
                throw new global::System.ArgumentNullException("first_name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string first_name, string last_name, string phone, string email, int Original_student_id, string Original_first_name, string Original_last_name, string Original_phone, string Original_email) {
            return this.Update(first_name, last_name, phone, email, Original_student_id, Original_first_name, Original_last_name, Original_phone, Original_email, Original_student_id);
        }
    }
